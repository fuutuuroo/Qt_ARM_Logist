...
По нажатию на такую ячейку открывается ещё одно окно для отправки заявки в отдел закупки для устранения нехватки этого товара. В нём отображаются город, наименование товара и его идентификатор, а также строка для ввода необходимого количества товара, кнопки отправки и закрытия. 
