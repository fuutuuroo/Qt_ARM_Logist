...
В данной программе используются 4 созданных класса:
...
Также в программе используются стандартные классы фреймворка Qt:
- QMainWindow - класс для отображения главного окна в проекте. 
- QVector - для использования вектора для хранения данных.
- QRandomGenerator - используется для генерации идентификатора.
- QMessageBox - отображение информационных сообщений.
- QDialog - базовый класс для отображения диалоговых окон, от него наследуются 2 дополнительных окна в проекте.  
...
<br>Видео записано с помощью программы OBS.
